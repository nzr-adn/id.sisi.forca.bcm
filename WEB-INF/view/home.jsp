					...
					<div class="flex items-center">
						...
						<div class="hidden md:block">
							<div class="ml-10 flex items-baseline space-x-4">
								...
								<div hx-get="/bcm/dashboard" hx-target="#content-div"
									hx-swap="innerHTML"
									class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white"
									aria-current="page">Dashboard</div>
								<div hx-get="/bcm/profile" hx-target="#content-div"
									hx-swap="innerHTML"
									class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Team</div>
								<a href="#"
